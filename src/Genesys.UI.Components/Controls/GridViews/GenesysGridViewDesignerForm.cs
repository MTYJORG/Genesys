...
{
    public class GenesysGridViewDesignerForm : Form
    {
        ...
        private readonly GenesysGridViewManager manager;
        ...
        public GenesysGridViewDesignerForm(
            GenesysGridViewManager manager)
        {
        ...
        {
            // La reordenación real se materializa al aplicar perfiles y guardar/capturar layout.
            // El diseñador usa el orden horizontal de sus encabezados como fuente visual.
            // Si más adelante exponemos ReorderColumns en el manager, aquí se conectará directo.
        }
