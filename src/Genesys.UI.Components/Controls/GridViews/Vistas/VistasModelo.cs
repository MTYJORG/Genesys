...
namespace Genesys.UI.Components.Controls.GridViews
{
    ...
    {
        public GenesysGridFilterPredicateLayout()
        {
            Properties = new List<GenesysGridFilterPredicatePropertyLayout>();
        }
        ...
        public string ActualFilterValue { get; set; }
        public string FilterValueType { get; set; }
        public bool IsCaseSensitive { get; set; }
        public string PredicateType { get; set; }

        public List<GenesysGridFilterPredicatePropertyLayout> Properties { get; set; }
    }

    [Serializable]
    public class GenesysGridFilterPredicatePropertyLayout
    {
