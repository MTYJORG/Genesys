namespace Genesys.UI.Components.Controls.Messages
{
    partial class GenesysMessages
    {
        ...
        {
            this.lblErroresIndicador = new Genesys.UI.Components.Controls.Messages.GradientLabel();
            this.lblErrores = new Genesys.UI.Components.Controls.Messages.GradientLabel();
            this.SuspendLayout();
            // 
            // lblErroresIndicador
            // 
